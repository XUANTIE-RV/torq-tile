...
/// Micro-kernel: W4A16 GEMM with 1xN bias and clamp (packed A and B)
///
...
/// scale_b is [n, k/bl] f16, and bias has shape [1, N] broadcast across rows.
...
/// Runs the W4A16 GEMM microkernel with packed matrices.
///
