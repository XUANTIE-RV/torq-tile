...
/// Micro-kernel: GEMM with 1xN bias and clamp for BF16
///
...
size_t tqt_get_m_step_gemm_1xnbias_clamp_bf16_bf16_bf16_8x1vl_rvv(void);
...
size_t tqt_get_n_step_gemm_1xnbias_clamp_bf16_bf16_bf16_8x1vl_rvv(void);
...
size_t tqt_get_a_offset_gemm_1xnbias_clamp_bf16_bf16_bf16_8x1vl_rvv(size_t m_idx, size_t k_idx,
                                                                    size_t lda);
...
///
/// @return The offset in bytes to the data element.
size_t tqt_get_b_offset_gemm_1xnbias_clamp_bf16_bf16_bf16_8x1vl_rvv(size_t n_idx, size_t k_idx,
                                                                    size_t ldb);
...
///
/// @return The offset in bytes to the data element.
size_t tqt_get_c_offset_gemm_1xnbias_clamp_bf16_bf16_bf16_8x1vl_rvv(size_t m_idx, size_t n_idx,
                                                                    size_t ldc);
...
size_t tqt_get_bias_offset_gemm_1xnbias_clamp_bf16_bf16_bf16_8x1vl_rvv(size_t n_idx);
...
///
/// @return The offset in bytes to the data element.
size_t tqt_get_d_offset_gemm_1xnbias_clamp_bf16_bf16_bf16_8x1vl_rvv(size_t m_idx, size_t n_idx,
                                                                    size_t ldd);
...
size_t tqt_get_d_size_gemm_1xnbias_clamp_bf16_bf16_bf16_8x1vl_rvv(size_t m, size_t n);
...
///
/// @note All matrices are in row-major format with bfloat16_t elements.
...
///
void tqt_run_gemm_1xnbias_clamp_bf16_bf16_bf16_8x1vl_rvv(
