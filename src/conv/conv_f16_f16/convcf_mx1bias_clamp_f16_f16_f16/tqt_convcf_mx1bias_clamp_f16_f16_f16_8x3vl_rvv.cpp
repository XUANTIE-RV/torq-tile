...
size_t tqt_get_b_im2col_offset_convcf_mx1bias_clamp_f16_f16_f16_8x3vl_rvv(size_t n_idx,
                                                                          ...
                                                                          size_t ldb_im2col)
{
    return (k_idx * ldb_im2col + n_idx) * sizeof(float16_t);
}
...
{
    tqt_im2col_cf<float16_t>(group_idx, activation, im2col_buf, params);
}
...
{
    tqt_run_gemm_mx1bias_clamp_f16_f16_f16_8x3vl_rvv(m, n, k, A, lda, k_idx_a, B, ldb, k_idx_b, C,
