...
#include "tqt_gemm_1xnbias_clamp_f32_bf16_bf16t_interface.h"

namespace
{
const tqt_gemm_1xnbias_clamp_f32_bf16_bf16t_ukernel ukernel{
...
int main()
{
    ...
    printf("TEST[gemm_1xnbias_clamp_f32_bf16_bf16t]\n");
    printf("- ukernel: gemm_1xnbias_clamp_f32_bf16_bf16t_8x1vl_rvv\n");
