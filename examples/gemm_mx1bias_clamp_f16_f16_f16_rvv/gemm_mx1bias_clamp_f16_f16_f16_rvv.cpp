...
#include "tqt_gemm_mx1bias_clamp_f16_f16_f16_interface.h"

namespace
{
/// Micro-kernel interface
const tqt_gemm_mx1bias_clamp_f16_f16_f16_ukernel ukernel{
...
// Note: B is in standard format (stored as k x n), bias is [M, 1]
                  ...
                  const float16_t *bias, float16_t clamp_min, float16_t clamp_max)
{
    for (size_t i = 0; i < m; ++i) {
        for (size_t j = 0; j < n; ++j) {
            ...
            // Add bias if provided (Mx1 bias: bias[i])
            if (bias != nullptr) {
...
int main()
{
    ...
    printf("TEST[gemm_mx1bias_clamp_f16_f16_f16]\n");
    printf("- ukernel: gemm_mx1bias_clamp_f16_f16_f16_8x3vl_rvv\n");
