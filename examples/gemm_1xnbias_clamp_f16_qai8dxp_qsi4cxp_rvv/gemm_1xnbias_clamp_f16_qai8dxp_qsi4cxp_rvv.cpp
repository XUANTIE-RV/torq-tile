...
#include "tqt_gemm_1xnbias_clamp_f16_qai8dxp_qsi4cxp_interface.h"

namespace
{

const tqt_gemm_1xnbias_clamp_f16_qai8dxp_qsi4cxp_ukernel ukernel{
    tqt_get_m_step_gemm_1xnbias_clamp_f16_qai8dxp_qsi4cxp_4x1vl_rvv,
    tqt_get_n_step_gemm_1xnbias_clamp_f16_qai8dxp_qsi4cxp_4x1vl_rvv,
    tqt_get_a_packed_offset_gemm_1xnbias_clamp_f16_qai8dxp_qsi4cxp_4x1vl_rvv,
    tqt_get_b_packed_offset_gemm_1xnbias_clamp_f16_qai8dxp_qsi4cxp_4x1vl_rvv,
    tqt_get_c_offset_gemm_1xnbias_clamp_f16_qai8dxp_qsi4cxp_4x1vl_rvv,
    tqt_get_bias_offset_gemm_1xnbias_clamp_f16_qai8dxp_qsi4cxp_4x1vl_rvv,
    tqt_get_d_offset_gemm_1xnbias_clamp_f16_qai8dxp_qsi4cxp_4x1vl_rvv,
    tqt_get_d_size_gemm_1xnbias_clamp_f16_qai8dxp_qsi4cxp_4x1vl_rvv,
    ...
    tqt_run_a_pack_gemm_1xnbias_clamp_f16_qai8dxp_qsi4cxp_4x1vl_rvv,
    tqt_run_bt_pack_gemm_1xnbias_clamp_f16_qai8dxp_qsi4cxp_4x1vl_rvv,
    tqt_run_gemm_1xnbias_clamp_f16_qai8dxp_qsi4cxp_4x1vl_rvv};
...
int main()
{
    ...
    std::vector<float16_t> bias(N), D_ref(M * N), D(M * N, (float16_t)0);

    fill_random(M * K, A_fp32.data(), -1.0f, 1.0f);
    fill_random(N * K, B_fp32.data(), -1.0f, 1.0f);
    for (size_t i = 0; i < N; ++i)
        bias[i] = (float16_t)(-0.5f + 1.0f * ((float)rand() / (float)RAND_MAX));
    ...
    const float clamp_min_f = -60000.0f, clamp_max_f = 60000.0f;
    ...
    printf("TEST[gemm_1xnbias_clamp_f16_qai8dxp_qsi4cxp]\n");
    printf("- ukernel: gemm_1xnbias_clamp_f16_qai8dxp_qsi4cxp_4x1vl_rvv\n");
