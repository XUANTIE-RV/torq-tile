...
#include "tqt_igemmcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8_interface.h"

namespace
{

/// Micro-kernel interface
const tqt_igemmcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8_ukernel ukernel{
    ...
    tqt_get_a_packed_offset_igemmcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8_1vlx4_rvv,
    tqt_get_c_offset_igemmcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8_1vlx4_rvv,
    tqt_get_bias_offset_igemmcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8_1vlx4_rvv,
    tqt_get_d_offset_igemmcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8_1vlx4_rvv,
    tqt_get_d_size_igemmcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8_1vlx4_rvv,
...
int main()
{
    ...
    ukernel.run_a_pack(M, K, K, K, 0, weight_i8, w_packed);

    // Run igemm micro-kernel with packed weight (no im2col needed)
    ukernel.run_igemm(M, N, K, activation_i8, 0, 0, 0, w_packed, K, 0, NULL, N, D_i8, N, bias_fused,
                      clamp_min, clamp_max, &conv_params, &qparams);
    ...
    printf("TEST[igemmcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8]\n");
    printf("- ukernel: igemmcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8_1vlx4_rvv\n");
