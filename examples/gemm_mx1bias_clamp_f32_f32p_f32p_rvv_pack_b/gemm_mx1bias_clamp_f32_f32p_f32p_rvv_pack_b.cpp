...
#include "tqt_gemm_mx1bias_clamp_f32_f32p_f32p_interface.h"

namespace
{

/// Micro-kernel interface
const tqt_gemm_mx1bias_clamp_f32_f32p_f32p_ukernel ukernel{
...
int main()
{
    ...
    fill_matrix_random(M, 1, bias, -10.0f, 10.0f);
    ...
    printf("TEST[gemm_mx1bias_clamp_f32_f32p_f32p]\n");
    printf("- ukernel: gemm_mx1bias_clamp_f32_f32p_f32p_8x3vl_rvv\n");
