...
#include "tqt_dwconvcl_1xnbias_clamp_f32_f32_f32t_1x1vl_rvv.h"
#include "tqt_dwconvcl_1xnbias_clamp_f32_f32_f32t_interface.h"

namespace
{
const tqt_dwconvcl_1xnbias_clamp_f32_f32_f32t_ukernel ukernel{
...
int main(void)
{
    ...
    ukernel.run_dwconv(input, weight, bias, out_actual, &p, 0.0f, FLT_MAX);
    ...
    std::free(out_ref);
    std::free(out_actual);
    std::printf("TEST[dwconvcl_1xnbias_clamp_f32_f32_f32t]\n");
    std::printf("- ukernel: dwconvcl_1xnbias_clamp_f32_f32_f32t_1x1vl_rvv\n");
