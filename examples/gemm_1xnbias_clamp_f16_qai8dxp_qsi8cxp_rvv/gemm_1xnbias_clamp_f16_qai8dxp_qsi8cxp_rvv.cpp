...
#include "tqt_gemm_1xnbias_clamp_f16_qai8dxp_qsi8cxp_4x1vl_rvv.h"
#include "tqt_gemm_1xnbias_clamp_f16_qai8dxp_qsi8cxp_interface.h"

namespace
{

const tqt_gemm_1xnbias_clamp_f16_qai8dxp_qsi8cxp_ukernel ukernel{
    ...
    tqt_get_c_offset_gemm_1xnbias_clamp_f16_qai8dxp_qsi8cxp_4x1vl_rvv,
    ...
    tqt_run_b_pack_gemm_1xnbias_clamp_f16_qai8dxp_qsi8cxp_4x1vl_rvv,
...
int main()
{
    ...
    if (!scale_a || !zp_a || !scale_b || !A_i8 || !BT_i8 || !A_packed || !B_packed || !bias_fp16 ||
        !D_act_fp16 || !D_act_fp32) {
        fprintf(stderr, "Memory allocation failed\n");
        return 1;
    }
    ...
    printf("TEST[gemm_1xnbias_clamp_f16_qai8dxp_qsi8cxp_rvv]\n");
    printf("- ukernel: gemm_1xnbias_clamp_f16_qai8dxp_qsi8cxp_4x1vl_rvv\n");
