...
#include "tqt_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv.h"
...
size_t tqt_get_m_step_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv(void)
{
    return m_step;
}

size_t tqt_get_n_step_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv(void)
{
    return n_step;
}

size_t tqt_get_a_packed_offset_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv(size_t m_idx,
                                                                             size_t k_idx,
                                                                             size_t lda,
                                                                             size_t actual_m)
{
...
size_t tqt_get_b_packed_offset_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv(size_t n_idx,
                                                                             size_t k_idx,
                                                                             size_t ldb,
                                                                             size_t actual_n)
{
...
size_t tqt_get_scale_b_offset_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv(size_t n_idx,
                                                                            size_t b_idx,
                                                                            size_t ldsb)
{
    TQT_ASSUME(n_idx % n_step == 0);
...
size_t tqt_get_c_offset_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv(size_t m_idx, size_t n_idx,
                                                                      size_t ldc)
{
    TQT_ASSUME(m_idx % m_step == 0);
    TQT_ASSUME(n_idx % n_step == 0);
...
size_t tqt_get_bias_offset_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv(size_t n_idx)
{
    TQT_ASSUME(n_idx % n_step == 0);
    return n_idx * sizeof(float16_t);
}

size_t tqt_get_d_offset_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv(size_t m_idx, size_t n_idx,
                                                                      size_t ldd)
{
    TQT_ASSUME(m_idx % m_step == 0);
    TQT_ASSUME(n_idx % n_step == 0);
...
size_t tqt_get_d_size_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv(size_t m, size_t n)
{
    return m * n * sizeof(float16_t);
}

size_t tqt_get_a_packed_size_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv(size_t m, size_t k)
{
    return m * k * sizeof(float16_t);
}

size_t tqt_get_b_packed_size_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv(size_t n, size_t k)
{
...
void tqt_run_a_pack_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv(size_t m, size_t k, size_t lda,
...
void tqt_run_bt_pack_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv(size_t n, size_t k, size_t ldb,
...
static void gemm_kernel(size_t K, size_t bl, float16_t *D, const float16_t *A_packed,
                        const uint8_t *B_packed, const float16_t *scale_b, const float16_t *C,
                        const float16_t *bias, size_t ldd, size_t lda, size_t ldb, size_t ldsb,
...
using gemm_kernel_fn_t = void (*)(size_t K, size_t bl, float16_t *D, const float16_t *A_packed,
                                  const uint8_t *B_packed, const float16_t *scale_b,
...
void tqt_run_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv(
