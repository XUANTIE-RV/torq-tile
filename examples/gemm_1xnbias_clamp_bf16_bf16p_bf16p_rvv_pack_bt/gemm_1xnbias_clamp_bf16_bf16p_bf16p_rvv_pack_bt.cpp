...
#include "tqt_gemm_1xnbias_clamp_bf16_bf16p_bf16p_interface.h"

namespace
{

/// Micro-kernel interface
const tqt_gemm_1xnbias_clamp_bf16_bf16p_bf16p_ukernel ukernel{
    ...
    for (size_t i = 0; i < m; ++i) {
        for (size_t j = 0; j < n; ++j) {
            ...
            for (size_t p = 0; p < k; ++p) {
                ...
                bfloat16_t b_val = B[j * ldb + p];  // B is transposed
                acc =
...
int main()
{
    ...
    bfloat16_t *B = (bfloat16_t *)malloc(N * K * sizeof(bfloat16_t));  // B is n x k (transposed)
    ...
    printf("TEST[gemm_1xnbias_clamp_bf16_bf16p_bf16p_pack_bt]\n");
    printf("- ukernel: gemm_1xnbias_clamp_bf16_bf16p_bf16p_8x1vl_rvv\n");
