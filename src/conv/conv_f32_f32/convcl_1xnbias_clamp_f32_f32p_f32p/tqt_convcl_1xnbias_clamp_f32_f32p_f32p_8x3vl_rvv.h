...
/// Conv micro-kernel: channel-last, 1xN bias, clamp, packed, FP32
...
/// @param[in]  B Input matrix B [n, k] in row-major format (transposed weight).
...
/// @param[in]  A_packed Packed input matrix A (im2col transformed activation).
/// @param[in]  lda Leading dimension of original A.
/// @param[in]  k_idx_a K index in A buffer (for sub-buffer scenarios).
/// @param[in]  B_packed Packed input matrix B (transposed weight).
