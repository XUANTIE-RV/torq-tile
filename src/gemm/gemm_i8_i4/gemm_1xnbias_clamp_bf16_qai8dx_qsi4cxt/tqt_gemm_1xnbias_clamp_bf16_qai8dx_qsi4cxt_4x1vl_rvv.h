...
/// Micro-kernel: W4A8 GEMM with 1xN bias and clamp (D = bf16 output)
///
...
///   - C is bf16[m, n] (optional, can be NULL).
///   - D is bf16[m, n].
///
...
/// @param[in]  C         Input matrix C [m, n] bf16 (optional, can be NULL).
/// @param[in]  ldc       Leading dimension of C (in bf16 elements).
/// @param[out] D         Output matrix D [m, n] bf16.
/// @param[in]  ldd       Leading dimension of D (in bf16 elements).
/// @param[in]  bias      Bias vector [1, n] bf16 (optional, can be NULL).
