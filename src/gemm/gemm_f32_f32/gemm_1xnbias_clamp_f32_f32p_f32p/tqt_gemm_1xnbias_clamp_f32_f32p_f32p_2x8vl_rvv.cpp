...
#include "tqt_gemm_1xnbias_clamp_f32_f32p_f32p_2x8vl_rvv.h"

#include "src/common/tqt_common.h"
#include "src/common/tqt_gemm_pack_rvv.h"
#include "src/gemm/gemm_f32_f32/tqt_kernel_gemm_f32_f32_2x8vl_rvv.h"
...
size_t tqt_get_m_step_gemm_1xnbias_clamp_f32_f32p_f32p_2x8vl_rvv(void)
{
    return m_step;
}

size_t tqt_get_n_step_gemm_1xnbias_clamp_f32_f32p_f32p_2x8vl_rvv(void)
{
    return n_step;
}

size_t tqt_get_a_packed_offset_gemm_1xnbias_clamp_f32_f32p_f32p_2x8vl_rvv(size_t m_idx,
...
size_t tqt_get_b_packed_offset_gemm_1xnbias_clamp_f32_f32p_f32p_2x8vl_rvv(size_t n_idx,
...
size_t tqt_get_c_offset_gemm_1xnbias_clamp_f32_f32p_f32p_2x8vl_rvv(size_t m_idx, size_t n_idx,
                                                                   size_t ldc)
{
    TQT_ASSUME(m_idx % m_step == 0);
    TQT_ASSUME(n_idx % n_step == 0);
...
size_t tqt_get_bias_offset_gemm_1xnbias_clamp_f32_f32p_f32p_2x8vl_rvv(size_t n_idx)
{
    TQT_ASSUME(n_idx % n_step == 0);
    return n_idx * sizeof(float);
}

size_t tqt_get_d_offset_gemm_1xnbias_clamp_f32_f32p_f32p_2x8vl_rvv(size_t m_idx, size_t n_idx,
                                                                   size_t ldd)
{
    TQT_ASSUME(m_idx % m_step == 0);
    TQT_ASSUME(n_idx % n_step == 0);
...
size_t tqt_get_d_size_gemm_1xnbias_clamp_f32_f32p_f32p_2x8vl_rvv(size_t m, size_t n)
{
    return m * n * sizeof(float);
}

size_t tqt_get_a_packed_size_gemm_1xnbias_clamp_f32_f32p_f32p_2x8vl_rvv(size_t m, size_t k)
{
    return m * k * sizeof(float);
}

size_t tqt_get_b_packed_size_gemm_1xnbias_clamp_f32_f32p_f32p_2x8vl_rvv(size_t n, size_t k)
{
...
void tqt_run_a_pack_gemm_1xnbias_clamp_f32_f32p_f32p_2x8vl_rvv(size_t m, size_t k, size_t lda,
...
void tqt_run_b_pack_gemm_1xnbias_clamp_f32_f32p_f32p_2x8vl_rvv(size_t n, size_t k, size_t ldb,
...
void tqt_run_bt_pack_gemm_1xnbias_clamp_f32_f32p_f32p_2x8vl_rvv(size_t n, size_t k, size_t ldb,
                                                                size_t ldb_packed, size_t k_idx,
                                                                const void *B, void *B_packed)
{
...
template <size_t MR>
static void gemm_kernel_8vl(size_t K, float *D, const float *A, const float *B, const float *C,
                            ...
                            float clamp_min, float clamp_max, size_t vl)
{
    ...
    if (C) {
        tqt_init_c_kernel_gemm_f32_f32_2x8vl_rvv<MR>(vl, C, ldc);
    } else {
        tqt_init_zero_kernel_gemm_f32_f32_2x8vl_rvv<MR>(vl);
    }

    // Prologue
    tqt_load_a_kernel_gemm_f32_f32_2x8vl_rvv<MR>(a_k_ptr, a_stride_row);
    tqt_load_b_kernel_gemm_f32_f32_2x8vl_rvv(vl, b_k_ptr);
    a_k_ptr += MR;
    b_k_ptr += vl;

    // Steady-state K-loop
    for (size_t k_idx = 1; k_idx < K; k_idx++) {
        tqt_fused_load_vfmacc_axb_kernel_gemm_f32_f32_2x8vl_rvv<MR>(vl, a_k_ptr, a_stride_row,
                                                                    b_k_ptr);
        a_k_ptr += MR;
        b_k_ptr += vl;
    }
    ...
    // Epilogue
    tqt_epilogue_vfmacc_kernel_gemm_f32_f32_2x8vl_rvv<MR>();

    if (bias) {
        tqt_add_1xnbias_kernel_gemm_f32_f32_2x8vl_rvv<MR>(vl, bias);
    }
    tqt_clamp_kernel_gemm_f32_f32_2x8vl_rvv<MR>(vl, clamp_min, clamp_max);
    tqt_store_kernel_gemm_f32_f32_2x8vl_rvv<MR>(vl, D, ldd);
}
...
static void gemm_mrxnr_8vl_rvv(size_t M, size_t N, size_t K, float *D, const float *A,
...
void tqt_run_gemm_1xnbias_clamp_f32_f32p_f32p_2x8vl_rvv(size_t m, size_t n, size_t k, const void *A,
