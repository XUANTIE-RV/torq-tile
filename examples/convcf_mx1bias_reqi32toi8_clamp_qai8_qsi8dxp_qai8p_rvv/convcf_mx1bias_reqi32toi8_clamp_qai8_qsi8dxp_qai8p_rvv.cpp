...
#include "tqt_convcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8p_interface.h"

namespace
{

/// Micro-kernel interface
const tqt_convcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8p_ukernel ukernel{
    ...
    tqt_get_a_packed_offset_convcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8p_4x1vl_rvv,
    tqt_get_b_im2colpack_offset_convcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8p_4x1vl_rvv,
    tqt_get_c_offset_convcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8p_4x1vl_rvv,
    tqt_get_bias_offset_convcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8p_4x1vl_rvv,
    tqt_get_d_offset_convcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8p_4x1vl_rvv,
    tqt_get_d_size_convcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8p_4x1vl_rvv,
...
// bias_fused[m] = bias_q[m] - zp_b * sum(weight_i8[m, 0..K-1])
...
int main()
{
    ...
    // Run micro-kernel implementation with packed matrices
    // Pack A (weight) [M, K]
    size_t a_packed_size = ukernel.get_a_packed_size(M, K);
    void *A_packed = malloc(a_packed_size);
    ukernel.run_a_pack(M, K, K, K, 0, weight_i8, A_packed);
    ...
    ukernel.run_b_im2colpack(0, activation_i8, K, 0, B_packed, &conv_params);

    // Run conv with packed matrices
    ukernel.run_conv(M, N, K, A_packed, K, 0, B_packed, K, 0, NULL, N, D_i8, N, bias_fused,
    ...
    printf("TEST[convcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8p]\n");
    printf("- ukernel: convcf_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8p_4x1vl_rvv\n");
