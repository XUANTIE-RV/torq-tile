...
///
/// @param[in] n_idx Row index (since B is transposed).
/// @param[in] k_idx Column index (since B is transposed).
...
/// @param[in]  n Number of rows in B (since B is transposed) and columns in D.
...
/// @note B is transposed, stored as [n, k] instead of [k, n].
