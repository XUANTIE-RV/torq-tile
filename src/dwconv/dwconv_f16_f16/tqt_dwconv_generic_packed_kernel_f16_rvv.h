...
// ============================================================================
// Family-level shared kernel for GENERIC packed dwconv (fp16, RVV).
//
...
static inline void tqt_dwconv_generic_packed_kernel_f16_rvv(
    const float16_t *packed_input, const float16_t *packed_weight, const float16_t *bias,
    float16_t *packed_output, const tqt_conv_params *params, float16_t clamp_min,
    float16_t clamp_max)
{
