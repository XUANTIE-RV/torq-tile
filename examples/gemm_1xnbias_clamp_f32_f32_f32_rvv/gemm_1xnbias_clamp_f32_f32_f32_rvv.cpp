...
#include "tqt_gemm_1xnbias_clamp_f32_f32_f32_interface.h"
...
int main()
{
    ...
    printf("TEST[gemm_1xnbias_clamp_f32_f32_f32]\n");
    printf("- ukernel: gemm_1xnbias_clamp_f32_f32_f32_8x3vl_rvv\n");
