...
#include "tqt_gemm_mx1bias_clamp_f16_f16_f16_8x3vl_rvv.h"
...
size_t tqt_get_m_step_gemm_mx1bias_clamp_f16_f16_f16_8x3vl_rvv(void)
{
    return m_step;
}

size_t tqt_get_n_step_gemm_mx1bias_clamp_f16_f16_f16_8x3vl_rvv(void)
{
    return n_step;
}

size_t tqt_get_a_offset_gemm_mx1bias_clamp_f16_f16_f16_8x3vl_rvv(size_t m_idx, size_t k_idx,
                                                                 size_t lda)
{
...
size_t tqt_get_b_offset_gemm_mx1bias_clamp_f16_f16_f16_8x3vl_rvv(size_t n_idx, size_t k_idx,
                                                                 size_t ldb)
{
...
size_t tqt_get_c_offset_gemm_mx1bias_clamp_f16_f16_f16_8x3vl_rvv(size_t m_idx, size_t n_idx,
                                                                 size_t ldc)
{
    TQT_ASSUME(m_idx % m_step == 0);
    TQT_ASSUME(n_idx % n_step == 0);
...
size_t tqt_get_bias_offset_gemm_mx1bias_clamp_f16_f16_f16_8x3vl_rvv(size_t m_idx)
{
    TQT_ASSUME(m_idx % m_step == 0);
    return m_idx * sizeof(float16_t);
}

size_t tqt_get_d_offset_gemm_mx1bias_clamp_f16_f16_f16_8x3vl_rvv(size_t m_idx, size_t n_idx,
                                                                 size_t ldd)
{
    TQT_ASSUME(m_idx % m_step == 0);
    TQT_ASSUME(n_idx % n_step == 0);
...
size_t tqt_get_d_size_gemm_mx1bias_clamp_f16_f16_f16_8x3vl_rvv(size_t m, size_t n)
{
...
void tqt_run_gemm_mx1bias_clamp_f16_f16_f16_8x3vl_rvv(size_t m, size_t n, size_t k, const void *A,
