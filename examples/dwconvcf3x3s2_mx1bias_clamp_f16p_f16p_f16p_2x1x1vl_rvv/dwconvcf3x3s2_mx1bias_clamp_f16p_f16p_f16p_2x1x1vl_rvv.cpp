...
#include "tqt_dwconvcf3x3s2_mx1bias_clamp_f16p_f16p_f16p_2x1x1vl_rvv.h"
#include "tqt_dwconvcf3x3s2_mx1bias_clamp_f16p_f16p_f16p_interface.h"

namespace
{
const tqt_dwconvcf3x3s2_mx1bias_clamp_f16p_f16p_f16p_ukernel ukernel{
...
int main(void)
{
    ...
    std::free(p_wt);
    std::free(p_out);
    std::printf("TEST[dwconvcf3x3s2_mx1bias_clamp_f16p_f16p_f16p]\n");
    std::printf("- ukernel: dwconvcf3x3s2_mx1bias_clamp_f16p_f16p_f16p_2x1x1vl_rvv\n");
