...
#include "tqt_convcl_1xnbias_clamp_f32_f32p_f32p_interface.h"

namespace
{
/// Micro-kernel interface
const tqt_convcl_1xnbias_clamp_f32_f32p_f32p_ukernel ukernel{
    tqt_get_m_step_convcl_1xnbias_clamp_f32_f32p_f32p_8x3vl_rvv,
    tqt_get_n_step_convcl_1xnbias_clamp_f32_f32p_f32p_8x3vl_rvv,
    tqt_get_a_im2colpack_offset_convcl_1xnbias_clamp_f32_f32p_f32p_8x3vl_rvv,
    tqt_get_b_packed_offset_convcl_1xnbias_clamp_f32_f32p_f32p_8x3vl_rvv,
    tqt_get_c_offset_convcl_1xnbias_clamp_f32_f32p_f32p_8x3vl_rvv,
    tqt_get_bias_offset_convcl_1xnbias_clamp_f32_f32p_f32p_8x3vl_rvv,
    tqt_get_d_offset_convcl_1xnbias_clamp_f32_f32p_f32p_8x3vl_rvv,
    tqt_get_d_size_convcl_1xnbias_clamp_f32_f32p_f32p_8x3vl_rvv,
...
int main()
{
    ...
    float *activation = (float *)malloc(ID * IH * IW * IC * sizeof(float));
    ...
    reference_conv_cl(activation, weight, bias, ref_output, &params, -FLT_MAX, FLT_MAX);
    ...
    ukernel.run_conv(M, N, K, A_packed, K, 0, B_packed, K, 0, NULL, N, act_output, N, bias,
                     -FLT_MAX, FLT_MAX);
    ...
    printf("TEST[convcl_1xnbias_clamp_f32_f32p_f32p]\n");
    printf("- ukernel: convcl_1xnbias_clamp_f32_f32p_f32p_8x3vl_rvv\n");
