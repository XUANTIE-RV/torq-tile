...
#include "tqt_igemmcf_mx1bias_clamp_f16_f16p_f16_3vlx8_rvv.h"
...
size_t tqt_get_m_step_igemmcf_mx1bias_clamp_f16_f16p_f16_3vlx8_rvv(void)
{
    return m_step;
}

size_t tqt_get_n_step_igemmcf_mx1bias_clamp_f16_f16p_f16_3vlx8_rvv(void)
{
    return n_step;
}

size_t tqt_get_a_packed_offset_igemmcf_mx1bias_clamp_f16_f16p_f16_3vlx8_rvv(size_t m_idx,
                                                                            size_t k_idx,
                                                                            size_t lda,
                                                                            size_t actual_m)
{
...
size_t tqt_get_c_offset_igemmcf_mx1bias_clamp_f16_f16p_f16_3vlx8_rvv(size_t m_idx, size_t n_idx,
                                                                     size_t ldc)
{
    TQT_ASSUME(m_idx % m_step == 0);
...
size_t tqt_get_bias_offset_igemmcf_mx1bias_clamp_f16_f16p_f16_3vlx8_rvv(size_t m_idx)
{
    TQT_ASSUME(m_idx % m_step == 0);
    return m_idx * sizeof(float16_t);
}

size_t tqt_get_d_offset_igemmcf_mx1bias_clamp_f16_f16p_f16_3vlx8_rvv(size_t m_idx, size_t n_idx,
                                                                     size_t ldd)
{
    TQT_ASSUME(m_idx % m_step == 0);
...
size_t tqt_get_d_size_igemmcf_mx1bias_clamp_f16_f16p_f16_3vlx8_rvv(size_t m, size_t n)
{
    return m * n * sizeof(float16_t);
}

size_t tqt_get_a_packed_size_igemmcf_mx1bias_clamp_f16_f16p_f16_3vlx8_rvv(size_t m, size_t k)
{
...
void tqt_run_a_pack_igemmcf_mx1bias_clamp_f16_f16p_f16_3vlx8_rvv(size_t m, size_t k, size_t ldw,
                                                                 ...
                                                                 void *weight_packed)
{
    ...
    tqt_gemm_pack_nxk_1x3vl_e16_rvv(m, k, ldw, ldw_packed, k_idx, weight, weight_packed);
}
...
static void igemmcf_packed_kernel(size_t K_inner, size_t ic_start, size_t ic_end, float16_t *D,
                                  const float16_t *W, const float16_t *input_group,
                                  const float16_t *C, const float16_t *bias, size_t ldd, size_t ldc,
                                  float16_t clamp_min, float16_t clamp_max, size_t vl,
                                  const int *od_arr, const int *oh_arr, const int *ow_arr,
                                  size_t ID, size_t IH, size_t IW, size_t KD, size_t KH, size_t KW,
        ...
        for (size_t kd = 0; kd < KD; kd++) {
            ...
            for (size_t kh = 0; kh < KH; kh++) {
                ...
                for (size_t kw = 0; kw < KW; kw++) {
                    ...
                    tqt_load_b_kernel_gemm_f16_f16_8x3vl_rvv<MR>(vl, w_ptr, vlmax);
                    // FMA
...
using igemmcf_packed_kernel_fn_t =
    void (*)(size_t K_inner, size_t ic_start, size_t ic_end, float16_t *D, const float16_t *W,
             const float16_t *input_group, const float16_t *C, const float16_t *bias, size_t ldd,
             size_t ldc, float16_t clamp_min, float16_t clamp_max, size_t vl, const int *od_arr,
             const int *oh_arr, const int *ow_arr, size_t ID, size_t IH, size_t IW, size_t KD,
             size_t KH, size_t KW, size_t SD, size_t SH, size_t SW, size_t DD, size_t DH, size_t DW,
             size_t PD, size_t PH, size_t PW, bool is_first_k, bool is_last_k);
...
static void igemmcf_packed_dispatch(
    size_t M, size_t N, size_t K_inner, size_t ic_start, size_t ic_end, float16_t *D,
...
void tqt_run_igemm_igemmcf_mx1bias_clamp_f16_f16p_f16_3vlx8_rvv(
    ...
    for (size_t n_idx_local = 0; n_idx_local < n; n_idx_local += n_step) {
        ...
        for (size_t m_idx = 0; m_idx < m; m_idx += m_step) {
            ...
            if (actual_m == m_step || k_idx_a == 0) {
                w_ptr = (const float16_t *)A_packed + m_idx * lda;
            } else {
                w_ptr = (const float16_t *)A_packed + m_idx * lda - k_idx_a * (m_step - actual_m);
            }
