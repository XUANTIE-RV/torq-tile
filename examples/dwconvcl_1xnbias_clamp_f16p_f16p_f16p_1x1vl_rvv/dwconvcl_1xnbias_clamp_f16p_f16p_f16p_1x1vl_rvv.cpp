...
#include "tqt_dwconvcl_1xnbias_clamp_f16p_f16p_f16p_interface.h"

namespace
{
const tqt_dwconvcl_1xnbias_clamp_f16p_f16p_f16p_ukernel ukernel{
...
int main(void)
{
    ...
    const size_t wt_count = OC * KH * KW;
    ...
    ukernel.run_dwconv(p_in, p_wt, bias, p_out, &p, (float16_t)0.0f, FLT_MAX);
    ...
    std::printf("TEST[dwconvcl_1xnbias_clamp_f16p_f16p_f16p]\n");
    std::printf("- ukernel: dwconvcl_1xnbias_clamp_f16p_f16p_f16p_1x1vl_rvv\n");
