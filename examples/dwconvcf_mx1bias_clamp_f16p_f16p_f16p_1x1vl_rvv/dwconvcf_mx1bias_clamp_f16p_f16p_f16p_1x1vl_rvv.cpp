...
#include "tqt_dwconvcf_mx1bias_clamp_f16p_f16p_f16p_1x1vl_rvv.h"
#include "tqt_dwconvcf_mx1bias_clamp_f16p_f16p_f16p_interface.h"

namespace
{
const tqt_dwconvcf_mx1bias_clamp_f16p_f16p_f16p_ukernel ukernel{
...
int main(void)
{
    ...
    std::printf("TEST[dwconvcf_mx1bias_clamp_f16p_f16p_f16p]\n");
    std::printf("- ukernel: dwconvcf_mx1bias_clamp_f16p_f16p_f16p_1x1vl_rvv\n");
