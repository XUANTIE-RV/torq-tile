...
// Generic dwconv (channel-first, NCDHW), Mx1 bias, clamp, FP16, non-packed.
...
typedef size_t (*tqt_dwconvcf_mx1bias_clamp_f16_f16_f16_get_output_size_func_t)(
    const tqt_conv_params *params);

/// Runs the dwconv. Processes ONE batch. Caller loops batch.
typedef void (*tqt_dwconvcf_mx1bias_clamp_f16_f16_f16_run_dwconv_func_t)(
...
struct tqt_dwconvcf_mx1bias_clamp_f16_f16_f16_ukernel
{
    tqt_dwconvcf_mx1bias_clamp_f16_f16_f16_get_output_size_func_t get_output_size;
    tqt_dwconvcf_mx1bias_clamp_f16_f16_f16_run_dwconv_func_t run_dwconv;
};
