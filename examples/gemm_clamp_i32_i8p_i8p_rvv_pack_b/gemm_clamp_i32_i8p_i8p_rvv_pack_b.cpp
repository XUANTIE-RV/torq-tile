...
#include "tqt_gemm_clamp_i32_i8p_i8p_interface.h"

namespace
{

/// Micro-kernel interface
const tqt_gemm_clamp_i32_i8p_i8p_ukernel ukernel{
    ...
    tqt_run_gemm_clamp_i32_i8p_i8p_4x1vl_rvv,
};
...
int main()
{
    ...
    printf("TEST[gemm_clamp_i32_i8p_i8p_rvv_pack_b]\n");
    printf("- ukernel: gemm_clamp_i32_i8p_i8p_4x1vl_rvv\n");
