...
{
    return tqt_get_m_step_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv();
}

size_t tqt_get_n_step_convcl_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv(void)
{
    return tqt_get_n_step_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv();
}
...
size_t tqt_get_b_offset_convcl_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv(size_t n_idx,
                                                                                    ...
                                                                                    size_t ldb)
{
    return tqt_get_b_offset_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv(n_idx, k_idx,
                                                                                      ldb);
}
...
size_t tqt_get_c_offset_convcl_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv(size_t m_idx,
                                                                                    ...
                                                                                    size_t ldc)
{
    return tqt_get_c_offset_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv(m_idx, n_idx,
                                                                                      ldc);
}

size_t tqt_get_bias_offset_convcl_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv(size_t n_idx)
{
    return tqt_get_bias_offset_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv(n_idx);
}
...
size_t tqt_get_d_offset_convcl_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv(size_t m_idx,
                                                                                    ...
                                                                                    size_t ldd)
{
    return tqt_get_d_offset_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv(m_idx, n_idx,
                                                                                      ldd);
}
...
size_t tqt_get_d_size_convcl_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv(size_t m,
                                                                                  size_t n)
{
    return tqt_get_d_size_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv(m, n);
}
...
{
    return (m_idx * lda_im2col + k_idx) * sizeof(int8_t);
}
...
{
    tqt_im2col_cl<int8_t>(group_idx, activation, im2col_buf, params);
}
