...
// Implicit GEMM micro-kernel type: igemmcf_mx1bias_clamp_f32_f32_f32
...
typedef size_t (*tqt_igemmcf_mx1bias_clamp_f32_f32_f32_get_m_step_func_t)(void);
typedef size_t (*tqt_igemmcf_mx1bias_clamp_f32_f32_f32_get_n_step_func_t)(void);
typedef size_t (*tqt_igemmcf_mx1bias_clamp_f32_f32_f32_get_a_offset_func_t)(size_t m_idx,
                                                                            size_t k_idx,
                                                                            size_t lda);
typedef size_t (*tqt_igemmcf_mx1bias_clamp_f32_f32_f32_get_c_offset_func_t)(size_t m_idx,
                                                                            size_t n_idx,
                                                                            size_t ldc);
typedef size_t (*tqt_igemmcf_mx1bias_clamp_f32_f32_f32_get_bias_offset_func_t)(size_t m_idx);
typedef size_t (*tqt_igemmcf_mx1bias_clamp_f32_f32_f32_get_d_offset_func_t)(size_t m_idx,
                                                                            size_t n_idx,
                                                                            size_t ldd);
typedef size_t (*tqt_igemmcf_mx1bias_clamp_f32_f32_f32_get_d_size_func_t)(size_t m, size_t n);
...
///                           × B_implicit[k_idx_b:k_idx_b+k, n_idx:n_idx+n]
///
...
typedef void (*tqt_igemmcf_mx1bias_clamp_f32_f32_f32_run_igemm_func_t)(
...
struct tqt_igemmcf_mx1bias_clamp_f32_f32_f32_ukernel
{
    tqt_igemmcf_mx1bias_clamp_f32_f32_f32_get_m_step_func_t get_m_step;
    tqt_igemmcf_mx1bias_clamp_f32_f32_f32_get_n_step_func_t get_n_step;
    tqt_igemmcf_mx1bias_clamp_f32_f32_f32_get_a_offset_func_t get_a_offset;
    tqt_igemmcf_mx1bias_clamp_f32_f32_f32_get_c_offset_func_t get_c_offset;
    tqt_igemmcf_mx1bias_clamp_f32_f32_f32_get_bias_offset_func_t get_bias_offset;
    tqt_igemmcf_mx1bias_clamp_f32_f32_f32_get_d_offset_func_t get_d_offset;
    tqt_igemmcf_mx1bias_clamp_f32_f32_f32_get_d_size_func_t get_d_size;
    tqt_igemmcf_mx1bias_clamp_f32_f32_f32_run_igemm_func_t run_igemm;
};
