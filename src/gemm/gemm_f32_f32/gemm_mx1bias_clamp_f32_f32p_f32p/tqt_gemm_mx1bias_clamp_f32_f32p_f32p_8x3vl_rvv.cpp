...
#include "tqt_gemm_mx1bias_clamp_f32_f32p_f32p_8x3vl_rvv.h"
...
size_t tqt_get_m_step_gemm_mx1bias_clamp_f32_f32p_f32p_8x3vl_rvv(void)
{
    return m_step;
}

size_t tqt_get_n_step_gemm_mx1bias_clamp_f32_f32p_f32p_8x3vl_rvv(void)
{
    return n_step;
}

size_t tqt_get_a_packed_offset_gemm_mx1bias_clamp_f32_f32p_f32p_8x3vl_rvv(size_t m_idx,
...
size_t tqt_get_b_packed_offset_gemm_mx1bias_clamp_f32_f32p_f32p_8x3vl_rvv(size_t n_idx,
...
size_t tqt_get_c_offset_gemm_mx1bias_clamp_f32_f32p_f32p_8x3vl_rvv(size_t m_idx, size_t n_idx,
                                                                   size_t ldc)
{
    TQT_ASSUME(m_idx % m_step == 0);
    TQT_ASSUME(n_idx % n_step == 0);
...
size_t tqt_get_d_offset_gemm_mx1bias_clamp_f32_f32p_f32p_8x3vl_rvv(size_t m_idx, size_t n_idx,
                                                                   size_t ldd)
{
    TQT_ASSUME(m_idx % m_step == 0);
    TQT_ASSUME(n_idx % n_step == 0);
...
size_t tqt_get_d_size_gemm_mx1bias_clamp_f32_f32p_f32p_8x3vl_rvv(size_t m, size_t n)
{
    return m * n * sizeof(float);
}

size_t tqt_get_a_packed_size_gemm_mx1bias_clamp_f32_f32p_f32p_8x3vl_rvv(size_t m, size_t k)
{
    return m * k * sizeof(float);
}

size_t tqt_get_b_packed_size_gemm_mx1bias_clamp_f32_f32p_f32p_8x3vl_rvv(size_t n, size_t k)
{
...
void tqt_run_a_pack_gemm_mx1bias_clamp_f32_f32p_f32p_8x3vl_rvv(size_t m, size_t k, size_t lda,
                                                               size_t lda_packed, size_t k_idx,
                                                               const void *A, void *A_packed)
{
    tqt_gemm_pack_mxk_8x1_e32_rvv(m, k, lda, lda_packed, k_idx, A, A_packed);
}

void tqt_run_b_pack_gemm_mx1bias_clamp_f32_f32p_f32p_8x3vl_rvv(size_t n, size_t k, size_t ldb,
                                                               size_t ldb_packed, size_t k_idx,
                                                               const void *B, void *B_packed)
{
    tqt_gemm_pack_kxn_1x3vl_rvv(n, k, ldb, ldb_packed, k_idx, B, B_packed, 32);
}

void tqt_run_bt_pack_gemm_mx1bias_clamp_f32_f32p_f32p_8x3vl_rvv(size_t n, size_t k, size_t ldb,
                                                                size_t ldb_packed, size_t k_idx,
                                                                const void *B, void *B_packed)
{
    tqt_gemm_pack_nxk_1x3vl_e32_rvv(n, k, ldb, ldb_packed, k_idx, B, B_packed);
}
