...
#include "tqt_gemm_1xnbias_clamp_f32_qai8dxp_qsi4cxp_interface.h"

namespace
{

const tqt_gemm_1xnbias_clamp_f32_qai8dxp_qsi4cxp_ukernel ukernel{
    tqt_get_m_step_gemm_1xnbias_clamp_f32_qai8dxp_qsi4cxp_4x1vl_rvv,
    tqt_get_n_step_gemm_1xnbias_clamp_f32_qai8dxp_qsi4cxp_4x1vl_rvv,
    tqt_get_a_packed_offset_gemm_1xnbias_clamp_f32_qai8dxp_qsi4cxp_4x1vl_rvv,
    tqt_get_b_packed_offset_gemm_1xnbias_clamp_f32_qai8dxp_qsi4cxp_4x1vl_rvv,
    tqt_get_c_offset_gemm_1xnbias_clamp_f32_qai8dxp_qsi4cxp_4x1vl_rvv,
    tqt_get_bias_offset_gemm_1xnbias_clamp_f32_qai8dxp_qsi4cxp_4x1vl_rvv,
    tqt_get_d_offset_gemm_1xnbias_clamp_f32_qai8dxp_qsi4cxp_4x1vl_rvv,
    tqt_get_d_size_gemm_1xnbias_clamp_f32_qai8dxp_qsi4cxp_4x1vl_rvv,
    ...
    tqt_run_a_pack_gemm_1xnbias_clamp_f32_qai8dxp_qsi4cxp_4x1vl_rvv,
    tqt_run_bt_pack_gemm_1xnbias_clamp_f32_qai8dxp_qsi4cxp_4x1vl_rvv,
    tqt_run_gemm_1xnbias_clamp_f32_qai8dxp_qsi4cxp_4x1vl_rvv};
...
int main()
{
    ...
    printf("TEST[gemm_1xnbias_clamp_f32_qai8dxp_qsi4cxp]\n");
    printf("- ukernel: gemm_1xnbias_clamp_f32_qai8dxp_qsi4cxp_4x1vl_rvv\n");
