...
#include "tqt_dwconvcf5x5s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv.h"
...
#include "src/dwconv/dwconv_f32_f32/tqt_dwconv_5x5s1_packed_kernel_f32_rvv.h"
...
size_t tqt_get_output_size_dwconvcf5x5s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv(
...
size_t tqt_get_packed_input_size_dwconvcf5x5s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv(
    const tqt_conv_params *params)
{
...
size_t tqt_get_packed_weight_size_dwconvcf5x5s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv(
    const tqt_conv_params *params)
{
...
size_t tqt_get_oh_step_dwconvcf5x5s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv(void)
{
    return oh_step;
}
...
void tqt_run_pack_input_dwconvcf5x5s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv(
    const void *input, void *packed_input, const tqt_conv_params *params)
{
    tqt_dwconv_pack_input_cf_f32_rvv((const float *)input, (float *)packed_input, params);
}

void tqt_run_pack_weight_dwconvcf5x5s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv(
    const void *weight, void *packed_weight, const tqt_conv_params *params)
{
    tqt_dwconv_pack_weight_cf_f32_rvv((const float *)weight, (float *)packed_weight, params);
}

void tqt_run_unpack_output_dwconvcf5x5s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv(
    const void *packed_output, void *output, const tqt_conv_params *params)
{
    tqt_dwconv_unpack_output_cf_f32_rvv((const float *)packed_output, (float *)output, params);
}

// ----- Compute -----

void tqt_run_dwconv_dwconvcf5x5s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv(
    ...
    float clamp_max)
{
    ...
    tqt_dwconv_5x5s1_packed_kernel_f32_rvv(oh_start, oh_end, (const float *)packed_input,
