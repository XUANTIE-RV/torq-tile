...
#include "tqt_dwconvcf_mx1bias_clamp_f32p_f32p_f32p_interface.h"

namespace
{
const tqt_dwconvcf_mx1bias_clamp_f32p_f32p_f32p_ukernel ukernel{
...
int main(void)
{
    ...
    ukernel.run_dwconv(p_in, p_wt, bias, p_out, &p, 0.0f, FLT_MAX);
    ...
    std::printf("TEST[dwconvcf_mx1bias_clamp_f32p_f32p_f32p]\n");
    std::printf("- ukernel: dwconvcf_mx1bias_clamp_f32p_f32p_f32p_1x1vl_rvv\n");
