...
#include "tqt_dwconvcf5x5s1_mx1bias_clamp_f32p_f32p_f32p_interface.h"

namespace
{
const tqt_dwconvcf5x5s1_mx1bias_clamp_f32p_f32p_f32p_ukernel ukernel{
...
int main(void)
{
    ...
    std::free(p_wt);
    std::free(p_out);
    std::printf("TEST[dwconvcf5x5s1_mx1bias_clamp_f32p_f32p_f32p]\n");
    std::printf("- ukernel: dwconvcf5x5s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv\n");
