...
/// Micro-kernel: GEMM with 1xN bias and clamp for BF16 with packed A and B
///
...
size_t tqt_get_m_step_gemm_1xnbias_clamp_bf16_bf16p_bf16p_8x1vl_rvv(void);
...
size_t tqt_get_n_step_gemm_1xnbias_clamp_bf16_bf16p_bf16p_8x1vl_rvv(void);
...
size_t tqt_get_a_packed_offset_gemm_1xnbias_clamp_bf16_bf16p_bf16p_8x1vl_rvv(size_t m_idx,
                                                                             size_t k_idx,
                                                                             size_t lda,
                                                                             size_t actual_m);
...
///
/// @return The offset in bytes to the data element.
size_t tqt_get_b_packed_offset_gemm_1xnbias_clamp_bf16_bf16p_bf16p_8x1vl_rvv(size_t n_idx,
                                                                             size_t k_idx,
                                                                             size_t ldb,
                                                                             size_t actual_n);
...
///
/// @return The offset in bytes to the data element.
size_t tqt_get_c_offset_gemm_1xnbias_clamp_bf16_bf16p_bf16p_8x1vl_rvv(size_t m_idx, size_t n_idx,
                                                                      size_t ldc);
...
size_t tqt_get_bias_offset_gemm_1xnbias_clamp_bf16_bf16p_bf16p_8x1vl_rvv(size_t n_idx);
...
///
/// @return The offset in bytes to the data element.
size_t tqt_get_d_offset_gemm_1xnbias_clamp_bf16_bf16p_bf16p_8x1vl_rvv(size_t m_idx, size_t n_idx,
                                                                      size_t ldd);
...
size_t tqt_get_d_size_gemm_1xnbias_clamp_bf16_bf16p_bf16p_8x1vl_rvv(size_t m, size_t n);
...
size_t tqt_get_a_packed_size_gemm_1xnbias_clamp_bf16_bf16p_bf16p_8x1vl_rvv(size_t m, size_t k);
...
size_t tqt_get_b_packed_size_gemm_1xnbias_clamp_bf16_bf16p_bf16p_8x1vl_rvv(size_t n, size_t k);
...
void tqt_run_a_pack_gemm_1xnbias_clamp_bf16_bf16p_bf16p_8x1vl_rvv(size_t m, size_t k, size_t lda,
...
void tqt_run_b_pack_gemm_1xnbias_clamp_bf16_bf16p_bf16p_8x1vl_rvv(size_t n, size_t k, size_t ldb,
...
/// @param[out] B_packed Packed matrix B buffer.
void tqt_run_bt_pack_gemm_1xnbias_clamp_bf16_bf16p_bf16p_8x1vl_rvv(size_t n, size_t k, size_t ldb,
                                                                   size_t ldb_packed, size_t k_idx,
                                                                   const void *B, void *B_packed);
...
///
void tqt_run_gemm_1xnbias_clamp_bf16_bf16p_bf16p_8x1vl_rvv(
