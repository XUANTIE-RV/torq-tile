...
#include "tqt_dwconvcf3x3s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv.h"
...
#include "src/dwconv/dwconv_f32_f32/tqt_dwconv_3x3s1_packed_kernel_f32_rvv.h"
...
size_t tqt_get_output_size_dwconvcf3x3s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv(
...
size_t tqt_get_packed_input_size_dwconvcf3x3s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv(
    const tqt_conv_params *params)
{
...
size_t tqt_get_packed_weight_size_dwconvcf3x3s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv(
    const tqt_conv_params *params)
{
...
size_t tqt_get_oh_step_dwconvcf3x3s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv(void)
{
    return oh_step;
}
...
void tqt_run_pack_input_dwconvcf3x3s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv(
...
void tqt_run_pack_weight_dwconvcf3x3s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv(
...
void tqt_run_unpack_output_dwconvcf3x3s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv(
...
void tqt_run_dwconv_dwconvcf3x3s1_mx1bias_clamp_f32p_f32p_f32p_4x1x1vl_rvv(
    ...
    float clamp_max)
{
    ...
    tqt_dwconv_3x3s1_packed_kernel_f32_rvv(oh_start, oh_end, (const float *)packed_input,
