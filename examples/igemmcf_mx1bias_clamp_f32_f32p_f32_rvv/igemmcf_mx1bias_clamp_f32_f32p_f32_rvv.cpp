...
#include "tqt_igemmcf_mx1bias_clamp_f32_f32p_f32_interface.h"

namespace
{
/// Micro-kernel interface
const tqt_igemmcf_mx1bias_clamp_f32_f32p_f32_ukernel ukernel{
    tqt_get_m_step_igemmcf_mx1bias_clamp_f32_f32p_f32_3vlx8_rvv,
    tqt_get_n_step_igemmcf_mx1bias_clamp_f32_f32p_f32_3vlx8_rvv,
    tqt_get_a_packed_offset_igemmcf_mx1bias_clamp_f32_f32p_f32_3vlx8_rvv,
    tqt_get_c_offset_igemmcf_mx1bias_clamp_f32_f32p_f32_3vlx8_rvv,
    tqt_get_bias_offset_igemmcf_mx1bias_clamp_f32_f32p_f32_3vlx8_rvv,
    tqt_get_d_offset_igemmcf_mx1bias_clamp_f32_f32p_f32_3vlx8_rvv,
    tqt_get_d_size_igemmcf_mx1bias_clamp_f32_f32p_f32_3vlx8_rvv,
...
int main()
{
    ...
    printf("TEST[igemmcf_mx1bias_clamp_f32_f32p_f32]\n");
    printf("- ukernel: igemmcf_mx1bias_clamp_f32_f32p_f32_3vlx8_rvv\n");
