...
#include "tqt_gemm_1xnbias_clamp_f32_bf16p_bf16p_8x1vl_rvv.h"
...
size_t tqt_get_m_step_gemm_1xnbias_clamp_f32_bf16p_bf16p_8x1vl_rvv(void)
{
    return m_step;
}

size_t tqt_get_n_step_gemm_1xnbias_clamp_f32_bf16p_bf16p_8x1vl_rvv(void)
{
    return n_step;
}

size_t tqt_get_a_packed_offset_gemm_1xnbias_clamp_f32_bf16p_bf16p_8x1vl_rvv(size_t m_idx,
                                                                            size_t k_idx,
                                                                            size_t lda,
                                                                            size_t actual_m)
{
...
size_t tqt_get_b_packed_offset_gemm_1xnbias_clamp_f32_bf16p_bf16p_8x1vl_rvv(size_t n_idx,
                                                                            size_t k_idx,
                                                                            size_t ldb,
                                                                            size_t actual_n)
{
...
size_t tqt_get_c_offset_gemm_1xnbias_clamp_f32_bf16p_bf16p_8x1vl_rvv(size_t m_idx, size_t n_idx,
                                                                     size_t ldc)
{
    TQT_ASSUME(m_idx % m_step == 0);
    TQT_ASSUME(n_idx % n_step == 0);
...
size_t tqt_get_bias_offset_gemm_1xnbias_clamp_f32_bf16p_bf16p_8x1vl_rvv(size_t n_idx)
{
    TQT_ASSUME(n_idx % n_step == 0);
    return n_idx * sizeof(float);
}

size_t tqt_get_d_offset_gemm_1xnbias_clamp_f32_bf16p_bf16p_8x1vl_rvv(size_t m_idx, size_t n_idx,
                                                                     size_t ldd)
{
    TQT_ASSUME(m_idx % m_step == 0);
    TQT_ASSUME(n_idx % n_step == 0);
...
size_t tqt_get_d_size_gemm_1xnbias_clamp_f32_bf16p_bf16p_8x1vl_rvv(size_t m, size_t n)
{
    return m * n * sizeof(float);
}

size_t tqt_get_a_packed_size_gemm_1xnbias_clamp_f32_bf16p_bf16p_8x1vl_rvv(size_t m, size_t k)
{
    return m * k * sizeof(bfloat16_t);
}

size_t tqt_get_b_packed_size_gemm_1xnbias_clamp_f32_bf16p_bf16p_8x1vl_rvv(size_t n, size_t k)
{
...
void tqt_run_a_pack_gemm_1xnbias_clamp_f32_bf16p_bf16p_8x1vl_rvv(size_t m, size_t k, size_t lda,
...
void tqt_run_b_pack_gemm_1xnbias_clamp_f32_bf16p_bf16p_8x1vl_rvv(size_t n, size_t k, size_t ldb,
...
void tqt_run_bt_pack_gemm_1xnbias_clamp_f32_bf16p_bf16p_8x1vl_rvv(size_t n, size_t k, size_t ldb,
                                                                  size_t ldb_packed, size_t k_idx,
                                                                  const void *B, void *B_packed)
{
...
template <size_t MR>
static void gemm_kernel(size_t K, float *D, const bfloat16_t *A, const bfloat16_t *B,
                        ...
                        size_t ldc, float clamp_min, float clamp_max, size_t vl)
{
    ...
    if (C) {
        tqt_init_c_f32_kernel_gemm_bf16_bf16_8x1vl_rvv<MR>(vl, C, ldc, 0);
    } else {
    ...
    if (bias) {
        tqt_add_1xnbias_f32_kernel_gemm_bf16_bf16_8x1vl_rvv<MR>(vl, bias);
    }
    tqt_clamp_fp32scalar_kernel_gemm_bf16_bf16_8x1vl_rvv<MR>(vl, clamp_min, clamp_max);

    tqt_store_f32_kernel_gemm_bf16_bf16_8x1vl_rvv<MR>(vl, D, d_stride_row);
}

using gemm_kernel_fn_t = void (*)(size_t K, float *D, const bfloat16_t *A, const bfloat16_t *B,
...
void tqt_run_gemm_1xnbias_clamp_f32_bf16p_bf16p_8x1vl_rvv(
