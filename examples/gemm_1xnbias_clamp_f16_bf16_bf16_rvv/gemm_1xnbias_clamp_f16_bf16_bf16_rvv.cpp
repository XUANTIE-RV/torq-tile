...
#include "tqt_gemm_1xnbias_clamp_f16_bf16_bf16_8x1vl_rvv.h"
#include "tqt_gemm_1xnbias_clamp_f16_bf16_bf16_interface.h"

namespace
{
const tqt_gemm_1xnbias_clamp_f16_bf16_bf16_ukernel ukernel{
...
int main()
{
    ...
    printf("TEST[gemm_1xnbias_clamp_f16_bf16_bf16]\n");
    printf("- ukernel: gemm_1xnbias_clamp_f16_bf16_bf16_8x1vl_rvv\n");
