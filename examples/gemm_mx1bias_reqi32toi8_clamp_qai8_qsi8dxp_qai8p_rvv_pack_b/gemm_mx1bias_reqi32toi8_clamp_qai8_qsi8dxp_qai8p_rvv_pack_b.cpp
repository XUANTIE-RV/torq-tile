...
#include "tqt_gemm_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8p_interface.h"

namespace
{

/// Micro-kernel interface
const tqt_gemm_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8p_ukernel ukernel{
...
int main()
{
    ...
    // Pack A and B (B from [K, N] layout)
    ...
    printf("TEST[gemm_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8p_rvv_pack_b]\n");
    printf("- ukernel: gemm_mx1bias_reqi32toi8_clamp_qai8_qsi8dxp_qai8p_4x1vl_rvv\n");
