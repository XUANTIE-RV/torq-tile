...
/// for qai8 (A) x qsi8cx (B packed per-channel) -> qai8 (D)
///
/// This is a rvv (4 x vl tile) implementation where vl = csrr_vlenb() / sizeof(int8).
/// Computes: D = clamp(requantize(C + A*B_packed + bias), min, max)
/// where A is int8 in original layout, B is pre-packed int8,
/// bias and C are int32, and D is int8.
///
/// Quantization scheme:
...
size_t tqt_get_m_step_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxp_4x1vl_rvv(void);
...
size_t tqt_get_n_step_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxp_4x1vl_rvv(void);
...
size_t tqt_get_a_offset_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxp_4x1vl_rvv(size_t m_idx,
                                                                                  size_t k_idx,
                                                                                  size_t lda);
...
///
/// @return The offset in bytes to the data element.
size_t tqt_get_b_packed_offset_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxp_4x1vl_rvv(
...
///
/// @return The offset in bytes to the data element.
size_t tqt_get_c_offset_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxp_4x1vl_rvv(size_t m_idx,
                                                                                  size_t n_idx,
                                                                                  size_t ldc);
...
size_t tqt_get_bias_offset_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxp_4x1vl_rvv(size_t n_idx);
...
///
/// @return The offset in bytes to the data element.
size_t tqt_get_d_offset_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxp_4x1vl_rvv(size_t m_idx,
                                                                                  size_t n_idx,
                                                                                  size_t ldd);
...
size_t tqt_get_d_size_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxp_4x1vl_rvv(size_t m, size_t n);
...
size_t tqt_get_b_packed_size_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxp_4x1vl_rvv(size_t n,
                                                                                       size_t k);
...
void tqt_run_b_pack_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxp_4x1vl_rvv(
...
/// @param[out] B_packed Packed matrix B buffer.
void tqt_run_bt_pack_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxp_4x1vl_rvv(
    size_t n, size_t k, size_t ldb, size_t ldb_packed, size_t k_idx, const void *B, void *B_packed);

/// Runs the GEMM microkernel with packed B, 1xN bias, requantization, and clamp.
///
/// Computes: D = clamp(requantize(C + A*B_packed + bias), clamp_min, clamp_max)
///
...
///
/// @note A is in standard row-major format.
/// @note B_packed is pre-packed using the pack functions.
/// @note k_idx_a and k_idx_b are used when A and B are sub-buffers with different sizes.
void tqt_run_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxp_4x1vl_rvv(
