...
static inline vfloat16m1_t tqt_dwconv_3x3s2_load_cell(const float16_t *in_block, long ih_in,
...
static inline void tqt_dwconv_3x3s2_packed_kernel_f16_rvv(
    ...
    for (size_t oc1 = 0; oc1 < OC1; ++oc1) {
        ...
        for (; oh + 2 <= oh_end; oh += 2) {
            ...
            for (size_t ow = 0; ow < OW; ++ow) {
                ...
                acc1 = __riscv_vfmacc_vv_f16m1(acc1, r2c0, w00, vl);
                acc1 = __riscv_vfmacc_vv_f16m1(acc1, r2c1, w01, vl);
                acc1 = __riscv_vfmacc_vv_f16m1(acc1, r2c2, w02, vl);
                // row 3 (ih3) -> acc1 (kh=1)
                acc1 = __riscv_vfmacc_vv_f16m1(acc1, r3c0, w10, vl);
                acc1 = __riscv_vfmacc_vv_f16m1(acc1, r3c1, w11, vl);
                acc1 = __riscv_vfmacc_vv_f16m1(acc1, r3c2, w12, vl);
                // row 4 (ih4) -> acc1 (kh=2)
                acc1 = __riscv_vfmacc_vv_f16m1(acc1, r4c0, w20, vl);
                acc1 = __riscv_vfmacc_vv_f16m1(acc1, r4c1, w21, vl);
                acc1 = __riscv_vfmacc_vv_f16m1(acc1, r4c2, w22, vl);
