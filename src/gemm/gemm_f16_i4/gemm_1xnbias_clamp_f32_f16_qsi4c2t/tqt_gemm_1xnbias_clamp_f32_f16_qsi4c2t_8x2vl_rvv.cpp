...
static void gemm_kernel(size_t K, size_t bl, float *D, const float16_t *A, const uint8_t *B,
...
using gemm_kernel_fn_t = void (*)(size_t K, size_t bl, float *D, const float16_t *A,
                                  const uint8_t *B, const float16_t *scale_b, const float *C,
...
static void gemm_mrxnr_rvv(size_t M, size_t N, size_t K, size_t bl, float *D, const float16_t *A,
                           const uint8_t *B, const float16_t *scale_b, const float *C,
