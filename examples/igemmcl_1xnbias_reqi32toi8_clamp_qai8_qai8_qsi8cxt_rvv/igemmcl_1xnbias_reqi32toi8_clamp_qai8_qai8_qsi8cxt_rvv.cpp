...
#include "tqt_igemmcl_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_interface.h"

namespace
{

/// Micro-kernel interface
const tqt_igemmcl_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_ukernel ukernel{
    ...
    tqt_get_b_offset_igemmcl_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv,
    tqt_get_c_offset_igemmcl_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv,
    tqt_get_bias_offset_igemmcl_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv,
    tqt_get_d_offset_igemmcl_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv,
    tqt_get_d_size_igemmcl_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv,
...
int main()
{
    ...
    // Run igemm micro-kernel (no im2col needed - input fetched on-the-fly)
    ukernel.run_igemm(M, N, K, activation_i8, 0, 0, 0, weight_i8, K, 0, NULL, N, D_i8, N,
                      bias_fused, clamp_min, clamp_max, &conv_params, &qparams);
    ...
    printf("TEST[igemmcl_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt]\n");
    printf("- ukernel: igemmcl_1xnbias_reqi32toi8_clamp_qai8_qai8_qsi8cxt_4x1vl_rvv\n");
