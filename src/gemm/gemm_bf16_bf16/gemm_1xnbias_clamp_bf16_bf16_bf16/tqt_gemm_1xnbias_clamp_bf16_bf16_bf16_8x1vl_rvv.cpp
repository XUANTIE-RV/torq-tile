                                                                    ...
                                                                    size_t ldb)
{
    ...
    return (k_idx * ldb + n_idx) * sizeof(bfloat16_t);
}
...
void tqt_run_gemm_1xnbias_clamp_bf16_bf16_bf16_8x1vl_rvv(size_t m, size_t n, size_t k,
                                                         ...
                                                         bfloat16_t clamp_min, bfloat16_t clamp_max)
{
    ...
    for (size_t m_idx = 0; m_idx < m; m_idx += m_step) {
        for (size_t n_idx = 0; n_idx < n; n_idx += n_step) {
            ...
            const bfloat16_t *b_ptr = (const bfloat16_t *)B + n_idx;
