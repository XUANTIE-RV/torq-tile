...
#include "tqt_gemm_1xnbias_clamp_f32_qai8dx_qsi8cxt_4x1vl_rvv.h"
#include "tqt_gemm_1xnbias_clamp_f32_qai8dx_qsi8cxt_interface.h"

namespace
{

const tqt_gemm_1xnbias_clamp_f32_qai8dx_qsi8cxt_ukernel ukernel{
    ...
    tqt_get_c_offset_gemm_1xnbias_clamp_f32_qai8dx_qsi8cxt_4x1vl_rvv,
...
int main()
{
    ...
    if (!scale_a || !zp_a || !scale_b || !A_i8 || !BT_i8 || !D_act_fp32) {
        fprintf(stderr, "Memory allocation failed\n");
        return 1;
    }
    ...
    printf("TEST[gemm_1xnbias_clamp_f32_qai8dx_qsi8cxt_rvv]\n");
    printf("- ukernel: gemm_1xnbias_clamp_f32_qai8dx_qsi8cxt_4x1vl_rvv\n");
