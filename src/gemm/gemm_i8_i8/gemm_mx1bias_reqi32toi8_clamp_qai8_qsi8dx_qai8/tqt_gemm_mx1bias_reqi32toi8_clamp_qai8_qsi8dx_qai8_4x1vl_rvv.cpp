...
size_t tqt_get_m_step_gemm_mx1bias_reqi32toi8_clamp_qai8_qsi8dx_qai8_4x1vl_rvv(void)
{
    return m_step;
}

size_t tqt_get_n_step_gemm_mx1bias_reqi32toi8_clamp_qai8_qsi8dx_qai8_4x1vl_rvv(void)
{
    return n_step;
}

size_t tqt_get_a_offset_gemm_mx1bias_reqi32toi8_clamp_qai8_qsi8dx_qai8_4x1vl_rvv(size_t m_idx,
                                                                                 size_t k_idx,
                                                                                 size_t lda)
{
...
size_t tqt_get_b_offset_gemm_mx1bias_reqi32toi8_clamp_qai8_qsi8dx_qai8_4x1vl_rvv(size_t n_idx,
                                                                                 size_t k_idx,
                                                                                 size_t ldb)
{
...
size_t tqt_get_c_offset_gemm_mx1bias_reqi32toi8_clamp_qai8_qsi8dx_qai8_4x1vl_rvv(size_t m_idx,
                                                                                 size_t n_idx,
                                                                                 size_t ldc)
{
    TQT_ASSUME(m_idx % m_step == 0);
...
size_t tqt_get_bias_offset_gemm_mx1bias_reqi32toi8_clamp_qai8_qsi8dx_qai8_4x1vl_rvv(size_t m_idx)
{
    TQT_ASSUME(m_idx % m_step == 0);
    return m_idx * sizeof(int32_t);
}

size_t tqt_get_d_offset_gemm_mx1bias_reqi32toi8_clamp_qai8_qsi8dx_qai8_4x1vl_rvv(size_t m_idx,
                                                                                 size_t n_idx,
                                                                                 size_t ldd)
{
    TQT_ASSUME(m_idx % m_step == 0);
...
size_t tqt_get_d_size_gemm_mx1bias_reqi32toi8_clamp_qai8_qsi8dx_qai8_4x1vl_rvv(size_t m, size_t n)
{
...
void tqt_run_gemm_mx1bias_reqi32toi8_clamp_qai8_qsi8dx_qai8_4x1vl_rvv(
