...
size_t tqt_get_m_step_gemm_1xnbias_clamp_f16_f16_f16p_8x3vl_rvv(void)
{
    return m_step;
}

size_t tqt_get_n_step_gemm_1xnbias_clamp_f16_f16_f16p_8x3vl_rvv(void)
{
    return n_step;
}

size_t tqt_get_a_offset_gemm_1xnbias_clamp_f16_f16_f16p_8x3vl_rvv(size_t m_idx, size_t k_idx,
                                                                  size_t lda)
{
...
size_t tqt_get_b_packed_offset_gemm_1xnbias_clamp_f16_f16_f16p_8x3vl_rvv(size_t n_idx, size_t k_idx,
                                                                         size_t ldb,
                                                                         size_t actual_n)
{
...
size_t tqt_get_c_offset_gemm_1xnbias_clamp_f16_f16_f16p_8x3vl_rvv(size_t m_idx, size_t n_idx,
                                                                  size_t ldc)
{
    TQT_ASSUME(m_idx % m_step == 0);
    TQT_ASSUME(n_idx % n_step == 0);
...
size_t tqt_get_bias_offset_gemm_1xnbias_clamp_f16_f16_f16p_8x3vl_rvv(size_t n_idx)
{
    TQT_ASSUME(n_idx % n_step == 0);
    return n_idx * sizeof(float16_t);
}

size_t tqt_get_d_offset_gemm_1xnbias_clamp_f16_f16_f16p_8x3vl_rvv(size_t m_idx, size_t n_idx,
                                                                  size_t ldd)
{
    TQT_ASSUME(m_idx % m_step == 0);
    TQT_ASSUME(n_idx % n_step == 0);
...
size_t tqt_get_d_size_gemm_1xnbias_clamp_f16_f16_f16p_8x3vl_rvv(size_t m, size_t n)
{
    return m * n * sizeof(float16_t);
}

size_t tqt_get_b_packed_size_gemm_1xnbias_clamp_f16_f16_f16p_8x3vl_rvv(size_t n, size_t k)
{
...
void tqt_run_b_pack_gemm_1xnbias_clamp_f16_f16_f16p_8x3vl_rvv(size_t n, size_t k, size_t ldb,
...
void tqt_run_bt_pack_gemm_1xnbias_clamp_f16_f16_f16p_8x3vl_rvv(size_t n, size_t k, size_t ldb,
                                                               size_t ldb_packed, size_t k_idx,
                                                               const void *B, void *B_packed)
{
...
static void gemm_kernel(size_t K, float16_t *D, const float16_t *A, const float16_t *B,
                        ...
                        size_t ldb, size_t ldc, float16_t clamp_min, float16_t clamp_max, size_t vl)
{
    ...
    // A: strided load (original row-major), B: unit-stride load (packed)
...
static void gemm_mrxnr_rvv(size_t M, size_t N, size_t K, float16_t *D, const float16_t *A,
...
void tqt_run_gemm_1xnbias_clamp_f16_f16_f16p_8x3vl_rvv(size_t m, size_t n, size_t k, const void *A,
    ...
    for (size_t m_idx = 0; m_idx < m; m_idx += m_step) {
        for (size_t n_idx = 0; n_idx < n; n_idx += n_step) {
            ...
            if (actual_n == n_step || k_idx_b == 0) {
                b_ptr = (const float16_t *)B_packed + n_idx * ldb;
            } else {
                b_ptr = (const float16_t *)B_packed + n_idx * ldb - k_idx_b * (n_step - actual_n);
            }
