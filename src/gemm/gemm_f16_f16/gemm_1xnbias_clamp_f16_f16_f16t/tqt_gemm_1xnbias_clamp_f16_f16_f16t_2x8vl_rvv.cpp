...
#include "tqt_gemm_1xnbias_clamp_f16_f16_f16t_2x8vl_rvv.h"
                            ...
                            size_t vl)
{
    ...
    tqt_load_bt_kernel_gemm_f16_f16_2x8vl_rvv(vl, b_ptr, ldb);
    a_ptr += 1;
    b_ptr += 1;

    for (size_t k_idx = 1; k_idx < K; k_idx++) {
        tqt_fused_load_vfmacc_axbt_kernel_gemm_f16_f16_2x8vl_rvv<MR>(vl, a_ptr, a_stride_row, b_ptr,
                                                                     ldb);
        a_ptr += 1;
        b_ptr += 1;
    }
