...
#include "tqt_dwconvcl_1xnbias_clamp_f32p_f32p_f32p_interface.h"

namespace
{
const tqt_dwconvcl_1xnbias_clamp_f32p_f32p_f32p_ukernel ukernel{
...
int main(void)
{
    ...
    std::printf("TEST[dwconvcl_1xnbias_clamp_f32p_f32p_f32p]\n");
    std::printf("- ukernel: dwconvcl_1xnbias_clamp_f32p_f32p_f32p_1x1vl_rvv\n");
