...
#include "tqt_dwconvcl3x3s2_1xnbias_clamp_f16p_f16p_f16p_interface.h"

namespace
{
const tqt_dwconvcl3x3s2_1xnbias_clamp_f16p_f16p_f16p_ukernel ukernel{
...
int main(void)
{
    ...
    std::free(p_wt);
    std::free(p_out);
    std::printf("TEST[dwconvcl3x3s2_1xnbias_clamp_f16p_f16p_f16p]\n");
    std::printf("- ukernel: dwconvcl3x3s2_1xnbias_clamp_f16p_f16p_f16p_2x1x1vl_rvv\n");
