...
#include "tqt_gemm_1xnbias_clamp_f16_bf16_bf16t_8x1vl_rvv.h"
#include "tqt_gemm_1xnbias_clamp_f16_bf16_bf16t_interface.h"

namespace
{
const tqt_gemm_1xnbias_clamp_f16_bf16_bf16t_ukernel ukernel{
...
// Reference implementation (B is transposed [n, k])
...
int main()
{
    ...
    printf("TEST[gemm_1xnbias_clamp_f16_bf16_bf16t]\n");
    printf("- ukernel: gemm_1xnbias_clamp_f16_bf16_bf16t_8x1vl_rvv\n");
