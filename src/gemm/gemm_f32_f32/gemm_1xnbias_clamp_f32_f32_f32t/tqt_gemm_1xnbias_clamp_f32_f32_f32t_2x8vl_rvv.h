...
/// Micro-kernel: GEMM with 1xN bias and clamp for FP32 (B transposed)
///
...
/// @param[in] ldb Leading dimension of B (for transposed B, ldb is the row stride).
///
/// @return The offset in bytes to the data element.
...
/// @param[in]  n Number of columns in B^T and D.
/// @param[in]  k Common dimension (columns of A, rows of B^T).
...
/// @note Uses LMUL=8 with runtime-variable vl to handle any N tail in [1, n_step].
///
