...
#include "tqt_convcl_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv.h"
...
{
    return tqt_get_m_step_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv();
}

size_t tqt_get_n_step_convcl_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv(void)
{
    return tqt_get_n_step_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv();
}
...
{
    return tqt_get_a_packed_offset_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv(
...
{
    return tqt_get_b_packed_offset_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv(
...
size_t tqt_get_c_offset_convcl_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv(size_t m_idx,
                                                                                     ...
                                                                                     size_t ldc)
{
    return tqt_get_c_offset_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv(m_idx, n_idx,
                                                                                       ldc);
}
...
size_t tqt_get_bias_offset_convcl_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv(
    size_t n_idx)
{
    return tqt_get_bias_offset_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv(n_idx);
}
...
size_t tqt_get_d_offset_convcl_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv(size_t m_idx,
                                                                                     ...
                                                                                     size_t ldd)
{
    return tqt_get_d_offset_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv(m_idx, n_idx,
                                                                                       ldd);
}
...
size_t tqt_get_d_size_convcl_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv(size_t m,
                                                                                   size_t n)
{
    return tqt_get_d_size_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv(m, n);
}

size_t tqt_get_a_im2colpack_size_convcl_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv(
    size_t m, size_t k)
{
    return tqt_get_a_packed_size_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv(m, k);
}

size_t tqt_get_b_packed_size_convcl_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv(size_t n,
                                                                                          size_t k)
{
    return tqt_get_b_packed_size_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv(n, k);
}
    ...
    size_t n, size_t k, size_t ldb, size_t ldb_packed, size_t k_idx, const void *B, void *B_packed)
{
    tqt_run_bt_pack_gemm_1xnbias_reqi32toi8_clamp_qai8_qai8p_qsi8cxp_4x1vl_rvv(
        n, k, ldb, ldb_packed, k_idx, B, B_packed);
}
...
static void a_im2colpack_cl_fill(int8_t *dst, size_t actual_m, size_t row_start,
                                 const int8_t *input, size_t C_total, size_t c_offset,
            ...
            for (size_t kw = 0; kw < KW; ++kw) {
                for (size_t r = 0; r < actual_m; ++r) {
                    ...
                    if (id_in >= 0 && id_in < (int)ID && ih_in >= 0 && ih_in < (int)IH &&
                        ...
                        const int8_t *s = src;
                        int8_t *d = dst + k_col * actual_m + r;
                        while (rem > 0) {
                            size_t vl = __riscv_vsetvl_e8m1(rem);
                            vint8m1_t v = __riscv_vle8_v_i8m1(s, vl);
                            __riscv_vsse8_v_i8m1(d, actual_m * sizeof(int8_t), v, vl);
                            s += vl;
                            d += vl * actual_m;
                            rem -= vl;
                        }
