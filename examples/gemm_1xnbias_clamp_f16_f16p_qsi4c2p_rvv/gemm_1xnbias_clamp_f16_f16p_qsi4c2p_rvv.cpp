...
#include "tqt_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_interface.h"

namespace
{

/// Micro-kernel interface
const tqt_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_ukernel ukernel{
    tqt_get_m_step_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv,
    tqt_get_n_step_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv,
    ...
    tqt_get_scale_b_offset_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv,
    tqt_get_c_offset_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv,
    tqt_get_bias_offset_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv,
    tqt_get_d_offset_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv,
    tqt_get_d_size_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv,
    tqt_get_a_packed_size_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv,
    tqt_get_b_packed_size_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv,
    tqt_run_a_pack_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv,
    tqt_run_bt_pack_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv,
    tqt_run_gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv};
...
// Quantize fp16 data to int4 with per-block scale
...
int main()
{
    ...
    // Run reference implementation (using original unpacked data)
    run_gemm_ref(M, N, K, BL, A, lda, B, ldb, scale_b, ldsb, C, ldc, bias, D_ref, ldd);

    // === Packed variant ===
    // Step 1: Allocate packed buffers
    ...
    // Step 3: Run packed GEMM using ukernel interface
    ...
    printf("TEST[gemm_1xnbias_clamp_f16_f16p_qsi4c2p]\n");
    printf("- ukernel: gemm_1xnbias_clamp_f16_f16p_qsi4c2p_8x2vl_rvv\n");
